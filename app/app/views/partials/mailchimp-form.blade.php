...
<div class="mc-field-group">
    ...
    <div style="position: absolute; left: -5000px;"><input type="text" name="b_507ecdf17b_f52aa3959b" value=""></div>
	<div class="clear"><input type="submit" value="{{ trans('home.subscribe') }}" name="subscribe" id="mc-embedded-subscribe" class="button"></div>
</form>
</div>
...
function mce_init_form(){
    jQuery(document).ready( function($) {
      ...
      options = { url: 'http://senlinx.us6.list-manage.com/subscribe/post-json?u=507ecdf17b&id=f52aa3959b&c=?', type: 'GET', dataType: 'json', contentType: "application/json; charset=utf-8",
