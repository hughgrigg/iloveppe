...
@section('content')
	...
	<ul class="medium-block-grid-6 small-block-grid-2">
		{{ Markup::featureItem('checkmark', 'guanyu-women.leixing.toubu', null, true) }}
		{{ Markup::featureItem('checkmark', 'guanyu-women.leixing.yanbu', null, true) }}
		{{ Markup::featureItem('checkmark', 'guanyu-women.leixing.tingli', null, true) }}
		{{ Markup::featureItem('checkmark', 'guanyu-women.leixing.zubu', null, true) }}
		{{ Markup::featureItem('checkmark', 'guanyu-women.leixing.shoubu', null, true) }}
		{{ Markup::featureItem('checkmark', 'guanyu-women.leixing.pifu', null, true) }}
	</ul>
